...
export default function LogoutButton({
  ...
  return (
    <>
      {/* Jika ada children (tombol dari Navbar), gunakan children. Jika tidak, pakai tombol default Profil */}
      {children ? (
        <div
        ...
        <button
          ...
          className={
            className ||
            "px-5 py-2.5 border border-red-200 dark:border-red-900/40 bg-red-50 dark:bg-red-950/10 hover:bg-red-100 dark:hover:bg-red-950/30 text-red-600 dark:text-red-400 font-bold text-xs rounded-xl transition-colors text-center shadow-sm dark:shadow-none cursor-pointer active:scale-95"
          }
        >
      ...
      {/* POPUP / MODAL KONFIRMASI LOGOUT */}
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200 text-left">
